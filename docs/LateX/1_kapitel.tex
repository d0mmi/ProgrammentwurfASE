...
Value Objects wurden für die Ranks und ReportTypes verwendet, da diese zwar in der Datenbank eine ID besitzten aber im restlichen Code diese nicht benötigen.
